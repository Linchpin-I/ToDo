...
export default Component.extend({
  ...
  filtered: computed('todos.@each.iaCompleted', 'filter', function() {
  ...
  completed: filterBy('todos', 'iaCompleted', true),
  active: filterBy('todos', 'iaCompleted', false),
  ...
  actions: {
    ...
    completeAll() {
      ...
      todos.setEach('iaCompleted', !allAreDone);
      todos.invoke('save');
    },
